...
public class Constantes {
	...
	public static final String TEMPLATE_SMS_AUDIENCIA_AGUARDANDO = "AUDIÊNCIA: Nova Audiência. "+ CONFIGURACAO_REPLACE_NUMERO_PROCESSO +", em "+ CONFIGURACAO_REPLACE_DATA +", "+ CONFIGURACAO_REPLACE_HORA +", no(a) "+ CONFIGURACAO_REPLACE_LOCAL +" e com "+ CONFIGURACAO_REPLACE_COLABORADOR;
	public static final String TEMPLATE_SMS_AUDIENCIA_REALIZADA = "AUDIÊNCIA: A sua opinião é importante! Em "+ CONFIGURACAO_REPLACE_DATA +" às "+ CONFIGURACAO_REPLACE_HORA +", V. S. foi acompanhado na audiência realizada pelo "+ CONFIGURACAO_REPLACE_COLABORADOR +". Envie sua crítica ou sugestão para o Coordenador.";
	public static final String TEMPLATE_SMS_AUDIENCIA_NAO_REALIZADA = "AUDIÊNCIA: A audiência anteriormente designada para o dia "+ CONFIGURACAO_REPLACE_DATA +" às "+ CONFIGURACAO_REPLACE_HORA +" na "+ CONFIGURACAO_REPLACE_LOCAL +" foi SUSPENSA, e não será mais realizada nesta data.";
	public static final String TEMPLATE_SMS_ANDAMENTO = "ANDAMENTO PROCESSUAL: Novo Andamento no seu processo " + CONFIGURACAO_REPLACE_NUMERO_PROCESSO + ", que tramita "+ CONFIGURACAO_REPLACE_LOCAL + ". Advogado responsável "+ CONFIGURACAO_REPLACE_COLABORADOR + ".";
	...
	public static final String TEMPLATE_SMS_INADIMPLENTES = "CENAJUR INFORMA: Até o momento não consta o pagamento do último mês. Favor Contactar a Associação. Caso já tenha efetuado o pagamento, desconsidere esta mensagem.";
